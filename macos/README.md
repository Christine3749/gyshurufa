...
- 简体／繁体／EN 三模式由 GY 保存；EN 完全直通应用。Mac 不绑定单独 Shift：日常中英切换使用系统的 Caps Lock、Fn/Globe 或输入源快捷键，模式可从 GY 菜单明确选择。
...
`release/release.json` 是跨端唯一版本真相。当前仍是 `1.0.10` 候选：未完成实体键盘升级矩阵、Developer ID 签名、公证与 stapling 前，不能改为公开发布。
