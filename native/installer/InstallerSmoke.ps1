...
Assert-Contains $installer 'close-apps-or-restart-required' 'ZIP installer does not record pending TSF core activation.'
...
Assert-Contains $manifestModule 'setupFile must match the canonical version' 'Release manifest does not enforce versioned installer naming.'
