...
Assert-Contains $manifestModule "'0.12.4'" 'Withdrawn 0.12.4 can re-enter the package or publication pipeline.'
Assert-Contains $manifestModule "'0.12.5'" 'Withdrawn 0.12.5 can re-enter the package or publication pipeline.'
...
Assert-Contains $manifestModule "'0.12.11'" 'Withdrawn 0.12.11 can re-enter the package or publication pipeline.'
