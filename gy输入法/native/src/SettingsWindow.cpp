...
Palette PaletteForTheme(int theme) {
  switch (theme) {
    ...
    case 2:  // 石墨: neutral graphite without the blue-night cast.
      return {RGB(21, 23, 28), RGB(30, 33, 40), RGB(44, 45, 49), RGB(36, 40, 48), RGB(54, 59, 70), RGB(244, 245, 247), RGB(148, 154, 168)};
    default:  // GY 蓝夜: the original dark palette.
      return {RGB(16, 18, 22), RGB(29, 33, 40), RGB(44, 45, 49), RGB(35, 39, 47), RGB(52, 58, 69), RGB(250, 250, 251), RGB(155, 163, 179)};
  }
}
