...
/// Background bridge between the local clipboard history and the account's
/// Keep notes stream.
///
...
/// Starts the 3-second poll and subscribes to local clipboard changes.
/// Idempotent.
- (void)start;
...
/// the previous account's newest entry.
